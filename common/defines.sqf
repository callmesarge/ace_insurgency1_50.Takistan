...
if(INS_ATVType1 == 2)then{"HMMWV_M1151_M2_DES_EP1"}else{\
if(INS_ATVType1 == 3)then{"HMMWV_M998A2_SOV_DES_EP1"}else{\
if(INS_ATVType1 == 4)then{"BAF_Jackal2_GMG_D"}else{\
if(INS_ATVType1 == 5)then{"BAF_Jackal2_L2A1_D"}else{\
if(INS_ATVType1 == 6)then{"BAF_Offroad_D"}else{\
if(INS_ATVType1 == 7)then{"MMT_Civ"}else{\
if(INS_ATVType1 == 8)then{"ACE_HMMWV_M2_USARMY"}else{\
...
["Stinger",2],\
["SMAW_HEDP",6],\
["ACE_10Rnd_127x99_Raufoss_m107",12],\
["20Rnd_B_AA12_HE",6],\
["20Rnd_B_AA12_Pellets",6],\
["ACE_5Rnd_762x51_T_M24",4],\
["20Rnd_762x51_B_SCAR",12],\
["200Rnd_556x45_M249",12],\
["PipeBomb",2],\
["ACE_Rope_TOW_M_5",1],\
["HandGrenade_West",4],\
["SmokeShell",4],\
